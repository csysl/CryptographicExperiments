 ...
 * 逆S盒
 */
const int S2[16][16] = {0x52, 0x09, 0x6a, 0xd5, 0x30, 0x36, 0xa5, 0x38, 0xbf, 0x40, 0xa3, 0x9e, 0x81, 0xf3, 0xd7, 0xfb,
 ...
 * 常量轮值表
 */
static const unsigned int Rcon[10] = {0x01000000, 0x02000000, 0x04000000, 0x08000000,
 ...
 * 参数 key: 密钥的字符串数组。
 */
void aes(char *p, int plen, char *key,int tag) {
...
void aesStrToFile(char *key,int tag) {
    ...
    aes(p, plen, key,tag);//AES加密
    printf("加密完成\n");
    char fileName[64]="../cipher.txt";
